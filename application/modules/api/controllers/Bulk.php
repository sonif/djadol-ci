            ...
            foreach ($data_receive as $det) {
                ...
                foreach ($form_child_param->result() as $p) {
                    if (isset($det->{$p->column_name})) {
                        $data_child[$p->column_name] = $det->{$p->column_name};
                    }
                }
                $data_child[$child_key] = $last_id;
                $data_child["company_id"] = $this->data["user"]->company_id;
                $this->db->insert($m_form_child->form_table, $data_child);
