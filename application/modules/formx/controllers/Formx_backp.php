...
class Formx extends MY_Controller
{
    ...
    public function data_tree()
    {
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $add  = '<a class="btn btn-icon-only openmodal" title="tambah" data-col[menu_parent]="'.$d->{$this->Formx_model->primary_key}.'"  data-url="'.site_url('formx/form/'.$form_id).'" data-id="div_modal_form_'.$form_id.'"><i class="fa fa-plus"></i></a>';
                $edit  = '<a class="btn btn-icon-only openmodal" title="edit"  data-url="'.site_url('formx/form/'.$form_id.'/'.$d->{$this->Formx_model->primary_key}).'" data-id="div_modal_form_'.$form_id.'"><i class="fa fa-pencil-square-o"></i></a>';
                $delete  = '<a class="btn btn-icon-only tree-delete" title="delete" data-id="'.$d->{$this->Formx_model->primary_key}.'" data-title="'.$d->{$col_label}.'" data-url="'.site_url('formx/formx/delete/'.$form_id.'/'.$d->{$this->Formx_model->primary_key}).'"><i class="fa fa-trash"></i></a>';
    ...
    public function table($form_id)
    {
        ...
        if ($m_form = $this->M_form->get($form_id)) {
            ...
            $data['m_form_filter'] = $this->db->where('form_id',$data['form']->id)->get('m_form_filter');
    ...
    public function getDatatable()
    {
        ...
        if ($get_data) {
            foreach ($get_data as $d) {
                ...
                $view  = '<button class="btn btn-icon-only green openmodal" title="view"  data-url="'.site_url('formx/read/'.$form_id.'/'.$d->{$this->Formx_model->primary_key}).'" data-id="div_modal_form_'.$form_id.'"><i class="fa fa-search fa-lg"></i></button>';
                $edit  = '<a class="btn btn-icon-only blue openmodal" title="edit"  data-url="'.site_url('formx/form/'.$form_id.'/'.$d->{$this->Formx_model->primary_key}).'" data-id="div_modal_form_'.$form_id.'"><i class="fa fa-pencil-square-o fa-lg"></i></a>';
                $approval  = '<a class="btn btn-icon-only yellow openmodal" title="approval"  data-url="'.site_url('formx/formx/approval_form/'.$form_id.'/'.$d->{$this->Formx_model->primary_key}).'" data-id="div_modal_form_'.$form_id.'"><i class="fa fa-check fa-lg"></i></a>';
                $delete  = '<button class="btn btn-icon-only red delete" title="delete" data-title="" data-url="'.site_url('formx/formx/delete/'.$form_id.'/'.$d->{$this->Formx_model->primary_key}).'"><i class="fa fa-trash fa-lg"></i></button>';

                // addtional button
                $add_btn = '';
                if (!empty($m_form->datatable_button_addon)) {
                    $add_btn = '<a class="btn btn-icon-only purple" title="view"  href="'.site_url($m_form->datatable_button_addon.$d->{$this->Formx_model->primary_key}).'" data-id="div_modal_form_'.$form_id.'"><i class="fa fa-download fa-lg"></i></a>';
                }
                ...
                if (isset($d->approval_note) && !empty($d->approval_note)) {
                    $edit='';
                    $approval  = '<a class="btn btn-icon-only yellow openmodal" title="approval"  data-url="'.site_url('formx/formx/approval_read/'.$form_id.'/'.$d->{$this->Formx_model->primary_key}).'" data-id="div_modal_form_'.$form_id.'"><i class="fa fa-comment fa-lg"></i></a>';
                }
    ...
    public function form($form_id=null,$id=null)
    {
        ...
        // if (in_array('xupdate', $ar_haklistakses)){
        // }
        // elseif (in_array('xread', $ar_haklistakses)){
        //     $this->data['authorize'] = 'readonly';
        // }else{
