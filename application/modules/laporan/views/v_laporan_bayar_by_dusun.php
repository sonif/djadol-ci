...
<div class='card shadow'>
        <div class='card-header'>
          <div class="col-7">
              <h5 class="h3 mb-0 text-uppercase">Laporan Pembayaran By Dusun  </h5>
          </div>
        </div>
...
<script>
    ...
    function load_report(year){
        $("#wrap_loading").show();
        $("#wrap_table").load("<?php echo site_url('laporan/laporan/bayar_by_dusun_ajax/');?>"+year, { limit: 25 }, function() {
            $("#wrap_loading").hide();
        });        
    }
