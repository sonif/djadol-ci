<div class="card">
  <div class='card-header'>
    <div class="row align-item-center">
      <div class="col-md-8">
        <h5 class="h3 mb-0 text-uppercase">Rincian</h5>
      </div>
    ...
    <tbody>
        ...
        ?>
            ...
            <tr <?php echo $tstyle; ?>>
                ...
                <td align="right" ><?php echo number_format($r->transaksi_subtotal); ?></td>   
                <td align="right" ><?php echo number_format($r->transaksi_pinalty); ?></td>
                <td align="right" ><?php echo number_format($r->transaksi_admin_price); ?></td>  
                <td align="right" ><?php echo number_format($r->transaksi_total); ?></td>   
            </tr>
