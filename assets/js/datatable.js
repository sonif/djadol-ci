    ...
    return {
        ...
        init: function(options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    // responsive: true,
                    "dom": "<'row'<'col-md-12 col-sm-12'pli><'col-md-5 col-sm-12'<'table-group-actions pull-right'>>r><'table-responsive't><'row'<'col-md-8 col-sm-12'pli><'col-md-4 col-sm-12'>>", // datatable layout
                    ...
                    "language": { // language settings
                        ...
                        "processing": '<div class="icon icon-shape bg-gradient-purple text-white rounded-circle shadow"><i class="fa fa-spinner fa-spin fa-2x fa-fw"></i></div>'
                    ...
                    "ajax": { // define ajax settings
                        ...
                        "data": function(data) { // add request parameters before submit
                            ...
                            // $.blockUI({ message: '<div class="icon icon-shape bg-gradient-purple text-white rounded-circle shadow"><i class="fa fa-spinner fa-spin fa-2x fa-fw"></i></div>' });
                            // $(tableContainer).blockUI({
                            //     message: '<div class="icon icon-shape bg-gradient-purple text-white rounded-circle shadow"><i class="fa fa-spinner fa-spin fa-2x fa-fw"></i></div>',
            ...
            table.on('click', '.delete', function(e) {
                ...
                //   text: $(this).data('title'),
                  ...
                  confirmButtonText: 'Yes, delete it!'
                    ...
                    if (isConfirm) {
                        $.post(url_del, {}, function(data, textStatus, xhr) {
